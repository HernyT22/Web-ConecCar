...
const Specs = ({ vehicle }: Props) => {
  ...
  return (
    <section className="py-20 md:py-24 bg-navy-50/40 border-b border-navy-100">
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {specs.map((s, i) => (
            <div key={i} className="rounded-2xl border border-navy-100 bg-white p-5 lift hover:border-amber-500/50 hover:shadow-[0_8px_30px_-12px_rgba(201,161,74,0.35)] transition">
